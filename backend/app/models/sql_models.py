...
class TarotCard(Base):
    ...
    arcana = Column(String, nullable=False)
...
class PalmReading(Base):
    ...
    hand_features = Column(JSON, default=dict, nullable=True)
...
class TarotReading(Base):
    ...
    id = Column(Integer, primary_key=True, index=True)
    user_id = Column(Integer, ForeignKey("users.id"), nullable=False, index=True)
    spread_name = Column(String, nullable=False)
...
class TarotReadingCard(Base):
    ...
    id = Column(Integer, primary_key=True, index=True)
    reading_id = Column(Integer, ForeignKey("tarot_readings.id"), nullable=False, index=True)
...
class AIInterpretation(Base):
    ...
    reading_id = Column(Integer, nullable=False, index=True)
