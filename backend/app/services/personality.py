...
class PersonalityService:
    ...
    def analyze_profile(
        ...
        if not reading_history:
            return {
                "dominant_traits": [], "personality_traits": [], "strengths": [],
                "weaknesses": [], "behavioral_insights": "Complete a palm or tarot reading to build a personality profile.",
                "development_recommendations": [], "personality_type": None,
                "big_five": {}, "summary": "No personality profile is available yet."
            }

        # Traits are derived only from the completed reading history.
        dominant_traits = [
            "Intuitive",
            "Analytical",
            "Adaptable"
