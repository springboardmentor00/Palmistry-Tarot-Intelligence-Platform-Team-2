...
from backend.app.models.sql_models import User, UserProfile
...
def register(user_in: UserRegister, db: Session = Depends(get_db)):
    ...
    # Public registration always creates a standard user. Elevated roles are
    # assigned only by an administrator through the RBAC-protected admin API.
    assigned_role = "USER"
    ...
    # Create User Profile with preferences and Zodiac Sign
    user_prefs = dict(user_in.preferences or {})
    if user_in.zodiac and "zodiac" not in user_prefs:
        user_prefs["zodiac"] = user_in.zodiac
